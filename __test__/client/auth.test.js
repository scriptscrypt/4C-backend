...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Victor_Pfeffer40',
      password: 'FsfW8lSCFO59wqu',
      email: 'Cleora_Cartwright85@gmail.com',
      name: 'Mrs. David Schamberger',
      shippingAddress: [
        {
          _id: false,
          pincode: 'connect',
          address1: 'deposit',
          address2: 'methodology',
          landmark: 'Hat',
          city: 'payment',
          isDefault: true,
          state: 'Movies',
      ...
      wishlist: [ {
        _id: false,
        productId: 'logistical' 
      } ],
      userType: 199,
      mobileNo: '(115) 953-7260',
      resetPasswordLink: {},
      loginRetryLimit: 944,
      loginReactiveTime: '2024-06-22T18:28:53.631Z',
      id: '65a7f6a304b1bf041492df52'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Elmer83',
        'password':'BHxhH9r0bVu7SKG',
        'email':'Kelley15@hotmail.com',
        'name':'Mr. Hannah Paucek',
        'shippingAddress':[{
          '_id':false,
          'pincode':'navigating',
          'address1':'Avon',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Kelley15@hotmail.com', });
